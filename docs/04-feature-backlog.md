...
| US-213 | **TERMINÉ le 2026-07-17 — patch des CVE npm** (frontend + outillage racine) | Deux `npm audit --audit-level=low` = 0 vulnérabilité après `npm ci` | SECURITY_AUDIT_2026-05.md:231-247 |
